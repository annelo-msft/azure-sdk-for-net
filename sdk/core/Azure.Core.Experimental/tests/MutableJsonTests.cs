...
{
    internal class MutableJsonTests
    {
        [Test]
        public void CanGetProperty()
        {
            ...
            MutableJsonWriteToTests.WriteToAndParse(jd, out string jsonString);

            Assert.AreEqual(
                MutableJsonWriteToTests.RemoveWhiteSpace(json),
                MutableJsonWriteToTests.RemoveWhiteSpace(jsonString));
        }
        ...
        public void CanSetProperty()
        {
            ...
            Assert.AreEqual(
                MutableJsonWriteToTests.RemoveWhiteSpace(@"
                {
                  ""Baz"" : {
                     ""A"" : 5.1
                  },
        ...
        public void CanAddPropertyToRootObject()
        {
            ...
            JsonDocument doc = MutableJsonWriteToTests.WriteToAndParse(jd, out string jsonString);
            ...
            Assert.AreEqual(MutableJsonWriteToTests.RemoveWhiteSpace(@"
                {
                  ""Foo"" : 1.2,
                  ""Bar"" : ""hi""
                }"), jsonString);
        ...
        public void HandlesReferenceSemantics()
        {
            ...
            Assert.AreEqual(MutableJsonWriteToTests.RemoveWhiteSpace(@"[ 5 ]"), jsonString);
        }
        ...
        public void CanSetProperty_StringToNumber()
        {
            ...
            Assert.AreEqual(MutableJsonWriteToTests.RemoveWhiteSpace(@"[ { ""Foo"" : 1.2 } ]"), jsonString);
        }
        ...
        public void CanSetProperty_StringToBool()
        {
            ...
            Assert.AreEqual(MutableJsonWriteToTests.RemoveWhiteSpace(@"[ { ""Foo"" : false } ]"), jsonString);
        }
        ...
        public void CanSetProperty_StringToArray()
        {
            ...
            Assert.AreEqual(MutableJsonWriteToTests.RemoveWhiteSpace(@"[ { ""Foo"" : [1, 2, 3] }]"), jsonString);
        }
        ...
        public void CanSetProperty_StringToNull()
        {
            ...
            Assert.AreEqual(MutableJsonWriteToTests.RemoveWhiteSpace(@"[ { ""Foo"" : null } ]"), jsonString);
        }
    }
}
