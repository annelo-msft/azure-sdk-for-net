...
{
    public static async ValueTask<PipelineResponse> ProcessMessageAsync(this Pipeline<PipelineMessage> pipeline, PipelineMessage message, InvocationOptions? requestContext, CancellationToken cancellationToken = default)
    {
    ...
    public static PipelineResponse ProcessMessage(this Pipeline<PipelineMessage> pipeline, PipelineMessage message, InvocationOptions? requestContext, CancellationToken cancellationToken = default)
    {
    ...
    public static async ValueTask<NullableResult<bool>> ProcessHeadAsBoolMessageAsync(this Pipeline<PipelineMessage> pipeline, PipelineMessage message, TelemetrySource clientDiagnostics, InvocationOptions? requestContext)
    {
    ...
    public static NullableResult<bool> ProcessHeadAsBoolMessage(this Pipeline<PipelineMessage> pipeline, PipelineMessage message, TelemetrySource clientDiagnostics, InvocationOptions? requestContext)
    {
