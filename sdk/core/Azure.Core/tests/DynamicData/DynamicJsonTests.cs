...
namespace Azure.Core.Tests
{
    public class DynamicJsonTests
    {
        ...
        {
            dynamic value = BinaryData.FromString("""{ "foo": 0 }""").ToDynamicFromJson(PropertyNameConversion.CamelCase);
        ...
        {
            dynamic json = BinaryData.FromString("""{ "foo": null }""").ToDynamicFromJson(PropertyNameConversion.CamelCase);
