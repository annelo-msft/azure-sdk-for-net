...
namespace Azure.Core.Samples
{
    ...
    public partial class WidgetHttp3Client
    {
        ...
        public WidgetHttp3Client(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new WidgetsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public WidgetHttp3Client(Uri endpoint, TokenCredential credential, WidgetsClientOptions options)
        {
    ...
    public partial class WidgetHttp3ClientOptions : ClientOptions
    {
        ...
        public WidgetHttp3ClientOptions(ServiceVersion version = LatestVersion)
        {
