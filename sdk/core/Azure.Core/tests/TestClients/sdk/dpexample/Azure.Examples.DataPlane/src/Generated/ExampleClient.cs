...
{
    /// <summary> The Example service client. </summary>
    public partial class ExampleClient
    {
        private static readonly string[] AuthorizationScopes = new string[] { "https://dpexample.azure.com/.default" };
        ...
        /// <summary> Initializes a new instance of ExampleClient for mocking. </summary>
        protected ExampleClient()
        {
        }

        /// <summary> Initializes a new instance of ExampleClient. </summary>
        /// <param name="serviceUrl"> The service url, for example https://name.azure.com. </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="serviceUrl"/> or <paramref name="credential"/> is null. </exception>
        public ExampleClient(string serviceUrl, TokenCredential credential) : this(serviceUrl, credential, new ExampleClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceUrl"/> or <paramref name="credential"/> is null. </exception>
        public ExampleClient(string serviceUrl, TokenCredential credential, ExampleClientOptions options)
        {
            Argument.AssertNotNull(serviceUrl, nameof(serviceUrl));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new ExampleClientOptions();
        ...
        public virtual async Task<Response> GetSecretAsync(string secretName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ExampleClient.GetSecret");
            scope.Start();
            try
            {
        ...
        internal HttpMessage CreateGetSecretRequest(string secretName, RequestContext context)
        {
            ...
            uri.AppendRaw(_serviceUrl, false);
