    ...
    public class ClientOptionsTests
    {
        ...
        public static IEnumerable<object[]> ClientOptionsTestValues()
        {
            ...
            yield return M(o =>
            {
                ...
                return policy;
            }, o => o.AzurePolicies?.LastOrDefault(p => p.Position == HttpPipelinePosition.PerCall).Policy);
            ...
            yield return M(o =>
            {
                ...
                return policy;
            }, o => o.AzurePolicies?.LastOrDefault(p => p.Position == HttpPipelinePosition.PerRetry).Policy);
            ...
            yield return M(o =>
            {
                ...
                return policy;
            }, o => o.AzurePolicies?.LastOrDefault(p => p.Position == HttpPipelinePosition.BeforeTransport).Policy);
