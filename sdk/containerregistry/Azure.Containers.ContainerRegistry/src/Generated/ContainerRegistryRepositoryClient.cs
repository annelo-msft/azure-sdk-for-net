...
namespace Azure.Containers.ContainerRegistry
{
    ...
    public partial class ContainerRegistryRepositoryClient
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ManifestAttributes>> GetManifestAttributesAsync(string name, string digest, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="digest"> Digest of a BLOB. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ManifestAttributes> GetManifestAttributes(string name, string digest, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ContainerRegistryRepositoryClient.GetManifestAttributes");
            scope.Start();
            try
        ...
        /// <param name="value"> Repository attribute value. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> UpdateManifestAttributesAsync(string name, string digest, ChangeableAttributes value = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="value"> Repository attribute value. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response UpdateManifestAttributes(string name, string digest, ChangeableAttributes value = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ContainerRegistryRepositoryClient.UpdateManifestAttributes");
            scope.Start();
            try
