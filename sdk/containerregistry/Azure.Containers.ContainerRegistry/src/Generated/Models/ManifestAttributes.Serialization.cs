...
namespace Azure.Containers.ContainerRegistry
{
    public partial class ManifestAttributes
    {
        internal static ManifestAttributes DeserializeManifestAttributes(JsonElement element)
        {
                ...
                if (property.NameEquals("manifest"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("changeableAttributes"))
                        {
                            ...
                            changeableAttributes = ChangeableAttributes.DeserializeChangeableAttributes(property0.Value);
                            continue;
                        }
                    }
                    continue;
            ...
            return new ManifestAttributes(registry.Value, imageName.Value, digest.Value, Optional.ToNullable(imageSize), Optional.ToNullable(createdTime), Optional.ToNullable(lastUpdateTime), architecture.Value, os.Value, mediaType.Value, configMediaType.Value, Optional.ToList(tags), changeableAttributes.Value);
        }
    }
}
