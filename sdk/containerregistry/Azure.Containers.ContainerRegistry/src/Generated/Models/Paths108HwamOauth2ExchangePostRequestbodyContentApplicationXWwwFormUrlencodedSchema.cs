...
namespace Azure.Containers.ContainerRegistry
{
    ...
    internal partial class Paths108HwamOauth2ExchangePostRequestbodyContentApplicationXWwwFormUrlencodedSchema
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="service"/>, <paramref name="tenant"/>, or <paramref name="aadAccesstoken"/> is null. </exception>
        internal Paths108HwamOauth2ExchangePostRequestbodyContentApplicationXWwwFormUrlencodedSchema(string service, string tenant, string aadAccesstoken)
        {
            if (service == null)
            {
