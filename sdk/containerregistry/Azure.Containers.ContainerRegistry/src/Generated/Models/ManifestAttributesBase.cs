...
namespace Azure.Containers.ContainerRegistry.Models
{
    ...
    internal partial class ManifestAttributesBase
    {
        ...
        internal ManifestAttributesBase(string digest, long? imageSize, string createdTime, string lastUpdateTime, string architecture, string os, string mediaType, string configMediaType, IReadOnlyList<string> tags, ContentPermissions changeableAttributes)
        {
            Digest = digest;
            ImageSize = imageSize;
