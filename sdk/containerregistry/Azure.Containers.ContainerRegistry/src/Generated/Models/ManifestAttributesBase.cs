...
namespace Azure.Containers.ContainerRegistry
{
    ...
    internal partial class ManifestAttributesBase
    {
        ...
        internal ManifestAttributesBase(string digest, long? imageSize, DateTimeOffset? createdTime, DateTimeOffset? lastUpdateTime, string architecture, string os, string mediaType, string configMediaType, IReadOnlyList<string> tags, ContentProperties changeableAttributes)
        {
            Digest = digest;
            ImageSize = imageSize;
