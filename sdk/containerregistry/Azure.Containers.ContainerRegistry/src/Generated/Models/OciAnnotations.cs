...
namespace Azure.Containers.ContainerRegistry.Specialized
{
    ...
    public partial class OciAnnotations
    {
        ...
        internal OciAnnotations(DateTimeOffset? createdOn, string authors, string url, string documentation, string source, string version, string revision, string vendor, string licenses, string name, string title, string description, IReadOnlyDictionary<string, object> additionalProperties)
        {
            CreatedOn = createdOn;
            Authors = authors;
            Url = url;
