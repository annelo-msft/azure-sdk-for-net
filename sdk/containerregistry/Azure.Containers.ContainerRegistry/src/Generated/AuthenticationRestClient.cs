...
namespace Azure.Containers.ContainerRegistry
{
    internal partial class AuthenticationRestClient
    {
        ...
        internal HttpMessage CreateExchangeAadTokenForAcrRefreshTokenRequest(string service, string tenant, string accessToken)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="service"/>, <paramref name="tenant"/>, or <paramref name="accessToken"/> is null. </exception>
        public async Task<Response<AcrRefreshToken>> ExchangeAadTokenForAcrRefreshTokenAsync(string service, string tenant, string accessToken, CancellationToken cancellationToken = default)
        {
            if (service == null)
            {
            ...
            using var message = CreateExchangeAadTokenForAcrRefreshTokenRequest(service, tenant, accessToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="service"/>, <paramref name="tenant"/>, or <paramref name="accessToken"/> is null. </exception>
        public Response<AcrRefreshToken> ExchangeAadTokenForAcrRefreshToken(string service, string tenant, string accessToken, CancellationToken cancellationToken = default)
        {
            if (service == null)
            {
                throw new ArgumentNullException(nameof(service));
