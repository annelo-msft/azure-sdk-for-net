...
namespace Azure.Containers.ContainerRegistry
{
    ...
    /// <para>
    /// The <see cref="ContainerRepositoryOperations"/> class is a helper class that groups information and operations about a repository in this
    /// container registry.
    /// </para>
    /// </summary>
    public partial class ContainerRepositoryOperations
    {
        ...
        /// <summary>
        /// </summary>
        internal ContainerRepositoryOperations(Uri registryEndpoint, string name, ClientDiagnostics clientDiagnostics, ContainerRegistryRestClient restClient)
        {
            _name = name;
        ...
        protected ContainerRepositoryOperations()
        {
        }

        /// <summary>
        /// Create a new <see cref="RegistryArtifactOperations"/> helper object for the artifact identified by <paramref name="tagOrDigest"/>.
        /// </summary>
        ...
        public virtual RegistryArtifactOperations GetArtifact(string tagOrDigest)
        {
        ...
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(ContainerRepositoryOperations)}.{nameof(GetProperties)}");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ContainerRepositoryProperties>> UpdatePropertiesAsync(ContainerRepositoryProperties value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(ContainerRepositoryOperations)}.{nameof(UpdateProperties)}");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(ContainerRepositoryOperations)}.{nameof(Delete)}");
            scope.Start();
            try
            {
