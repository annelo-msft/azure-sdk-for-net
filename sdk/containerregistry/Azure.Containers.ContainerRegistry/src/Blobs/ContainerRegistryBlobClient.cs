...
namespace Azure.Containers.ContainerRegistry.Blobs
{
    ...
    public partial class ContainerRegistryBlobClient
    {
        ...
        public ContainerRegistryBlobClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new ContainerRegistryClientOptions())
        {
        }

        public ContainerRegistryBlobClient(Uri endpoint, TokenCredential credential, ContainerRegistryClientOptions options)
        {
        }
