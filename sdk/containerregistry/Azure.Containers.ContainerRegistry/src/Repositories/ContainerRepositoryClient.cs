...
namespace Azure.Containers.ContainerRegistry
{
    ...
    public partial class ContainerRepositoryClient
    {
        ...
        public ContainerRepositoryClient(Uri endpoint, string repository, TokenCredential credential, ContainerRegistryClientOptions options)
        {
            ...
            _authenticationClient = new AuthenticationRestClient(_clientDiagnostics, _acrAuthPipeline, endpoint.AbsoluteUri);

            _pipeline = HttpPipelineBuilder.Build(options, new ContainerRegistryCredentialsPolicy(credential, AcrAadScope, _authenticationClient));
