...
namespace Azure.Containers.ContainerRegistry
{
    ...
    /// <para>
    /// The <see cref="RegistryArtifactOperations"/> class is a helper class that groups information and operations about an image or artifact in this container registry.
    /// </para>
    /// </summary>
    public partial class RegistryArtifactOperations
    {
        ...
        /// <summary>
        /// </summary>
        internal RegistryArtifactOperations(Uri registryEndpoint, string repositoryName, string tagOrDigest, ClientDiagnostics clientDiagnostics, ContainerRegistryRestClient restClient)
        {
        ...
        protected RegistryArtifactOperations()
        {
        }
        ...
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(RegistryArtifactOperations)}.{nameof(GetManifestProperties)}");
            scope.Start();
        ...
        public virtual async Task<Response<ArtifactManifestProperties>> UpdateManifestPropertiesAsync(ArtifactManifestProperties value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(RegistryArtifactOperations)}.{nameof(UpdateManifestProperties)}");
            scope.Start();
            try
            {
                string digest = await GetDigestAsync(cancellationToken).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(RegistryArtifactOperations)}.{nameof(Delete)}");
            scope.Start();
            try
            {
                string digest = await GetDigestAsync(cancellationToken).ConfigureAwait(false);
        ...
        public virtual AsyncPageable<ArtifactTagProperties> GetTagPropertiesCollectionAsync(ArtifactTagOrderBy orderBy = ArtifactTagOrderBy.None, CancellationToken cancellationToken = default)
        {
            ...
            {
                using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(RegistryArtifactOperations)}.{nameof(GetTagPropertiesCollection)}");
                scope.Start();
                try
                {
                    string digest = await GetDigestAsync(cancellationToken).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(RegistryArtifactOperations)}.{nameof(GetTagProperties)}");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ArtifactTagProperties>> UpdateTagPropertiesAsync(string tag, ArtifactTagProperties value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(RegistryArtifactOperations)}.{nameof(UpdateTagProperties)}");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteTagAsync(string tag, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(RegistryArtifactOperations)}.{nameof(DeleteTag)}");
            scope.Start();
            try
            {
