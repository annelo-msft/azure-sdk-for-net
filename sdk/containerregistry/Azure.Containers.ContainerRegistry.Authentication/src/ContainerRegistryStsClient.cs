...
namespace Azure.Containers.ContainerRegistry.Authentication
{
    public class ContainerRegistryStsClient
    {
        ...
        public ContainerRegistryStsClient(Uri endpoint, ContainerRegistryUserCredential credential) : this(endpoint, credential, new ContainerRegistryClientOptions())
        {
        }

        public ContainerRegistryStsClient(Uri endpoint, ContainerRegistryUserCredential credential, ContainerRegistryClientOptions options)
        {
        }
