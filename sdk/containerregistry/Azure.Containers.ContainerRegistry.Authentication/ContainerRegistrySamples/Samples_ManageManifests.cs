...
namespace ContainerRegistrySamples
{
    public class Sample_ManageManifests
    {
        ...
        public async Task GetManifestMetadata()
        {
            ...
            // By Tag
            RepositoryItemProperties manifestAttributes = await repositoryClient.GetManifestAsync("latest");
        ...
        private void ArtifactAttributes(RepositoryItemProperties artifactAttributes)
        {
            // Print Manifest
