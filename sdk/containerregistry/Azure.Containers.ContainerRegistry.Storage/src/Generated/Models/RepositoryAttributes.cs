...
namespace Azure.Containers.ContainerRegistry.Storage
{
    ...
    public partial class RepositoryAttributes
    {
        ...
        internal RepositoryAttributes(string registry, string imageName, DateTimeOffset? createdTime, DateTimeOffset? lastUpdateTime, int? manifestCount, int? tagCount, ChangeableAttributes changeableAttributes)
        {
            Registry = registry;
            ImageName = imageName;
