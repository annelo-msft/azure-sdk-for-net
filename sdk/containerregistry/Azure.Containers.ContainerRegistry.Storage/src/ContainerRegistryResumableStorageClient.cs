...
namespace Azure.Containers.ContainerRegistry.Storage
{
    ...
    public partial class ContainerRegistryResumableStorageClient
    {
        ...
        public virtual async Task<Response<RegistryItemManifest>> GetManifestAsync(string reference, IEnumerable<ManifestMediaType> acceptMediaTypes = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Get the manifest identified by `name` and `reference` where `reference` can be a tag or digest. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<RegistryItemManifest> GetManifest(string reference, IEnumerable<ManifestMediaType> acceptMediaTypes = null, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
            //using var scope = _clientDiagnostics.CreateScope("ContainerRegistryRepositoryClient.GetManifest");
            //scope.Start();
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CreateManifestResult>> CreateManifestAsync(string tag, RegistryItemManifest manifest, CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Put the manifest identified by tag. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CreateManifestResult> CreateManifest(string tag, RegistryItemManifest manifest, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ContainerRegistryRepositoryClient.CreateManifest");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CreateManifestResult>> CreateManifestAsync(RegistryItemManifest manifest, CancellationToken cancellationToken = default)
        {
            // TODO: How should we handle the accept header?  This feels like part of the polymorphic/strong-typing story around manifests
            ///// <param name="payload"> Manifest body, can take v1 or v2 values depending on accept header. </param>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CreateManifestResult> CreateManifest(RegistryItemManifest manifest, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ContainerRegistryRepositoryClient.CreateManifest");
            scope.Start();
            try
