...
namespace Azure.Template
{
    internal partial class AccessTokensRestClient
    {
        ...
        public async Task<Response<Models.AccessToken>> GetAsync(string service, string scope, string refreshToken, CancellationToken cancellationToken = default)
        {
            if (service == null)
            {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        Models.AccessToken value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = Models.AccessToken.DeserializeAccessToken(document.RootElement);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="service"/>, <paramref name="scope"/>, or <paramref name="refreshToken"/> is null. </exception>
        public Response<Models.AccessToken> Get(string service, string scope, string refreshToken, CancellationToken cancellationToken = default)
        {
            if (service == null)
            {
                throw new ArgumentNullException(nameof(service));
        ...
        public async Task<Response<Models.AccessToken>> GetFromLoginAsync(string service, string scope, CancellationToken cancellationToken = default)
        {
            if (service == null)
            {
                throw new ArgumentNullException(nameof(service));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="service"/> or <paramref name="scope"/> is null. </exception>
        public Response<Models.AccessToken> GetFromLogin(string service, string scope, CancellationToken cancellationToken = default)
        {
            if (service == null)
            {
                throw new ArgumentNullException(nameof(service));
