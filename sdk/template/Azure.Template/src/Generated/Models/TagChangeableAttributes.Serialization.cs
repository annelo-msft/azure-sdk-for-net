...
{
    public partial class TagChangeableAttributes : IUtf8JsonSerializable
    {
        ...
        internal static TagChangeableAttributes DeserializeTagChangeableAttributes(JsonElement element)
        {
            ...
            return new TagChangeableAttributes(Optional.ToNullable(deleteEnabled), Optional.ToNullable(writeEnabled), Optional.ToNullable(listEnabled), Optional.ToNullable(readEnabled));
        }
    }
}
