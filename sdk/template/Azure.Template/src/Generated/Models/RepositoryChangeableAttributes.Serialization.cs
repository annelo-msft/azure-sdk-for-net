...
{
    public partial class RepositoryChangeableAttributes : IUtf8JsonSerializable
    {
        ...
        internal static RepositoryChangeableAttributes DeserializeRepositoryChangeableAttributes(JsonElement element)
        {
            ...
            return new RepositoryChangeableAttributes(Optional.ToNullable(deleteEnabled), Optional.ToNullable(writeEnabled), Optional.ToNullable(listEnabled), Optional.ToNullable(readEnabled), Optional.ToNullable(teleportEnabled));
        }
    }
}
