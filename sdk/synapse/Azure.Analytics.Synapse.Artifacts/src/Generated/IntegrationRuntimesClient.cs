...
namespace Azure.Analytics.Synapse.Artifacts
{
    ...
    public partial class IntegrationRuntimesClient
    {
        ...
        public IntegrationRuntimesClient(Uri endpoint, TokenCredential credential, ArtifactsClientOptions options = null)
        {
            ...
            RestClient = new IntegrationRuntimesRestClient(_clientDiagnostics, _pipeline, endpoint, options.Version);
        }
        ...
        internal IntegrationRuntimesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion = "2020-12-01")
        {
            RestClient = new IntegrationRuntimesRestClient(clientDiagnostics, pipeline, endpoint, apiVersion);
