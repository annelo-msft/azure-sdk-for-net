...
namespace Azure.Communication.JobRouter.Models
{
    ...
    public partial class RouterJob
    {
        ...
        internal RouterJob(string id, string channelReference, RouterJobStatus? status, DateTimeOffset? enqueuedAt, string channelId, string classificationPolicyId, string queueId, int? priority, string dispositionCode, IList<RouterWorkerSelector> requestedWorkerSelectors, IReadOnlyList<RouterWorkerSelector> attachedWorkerSelectors, IDictionary<string, Value> labels, IReadOnlyDictionary<string, RouterJobAssignment> assignments, IDictionary<string, Value> tags, IDictionary<string, string> notes, DateTimeOffset? scheduledAt, JobMatchingMode matchingMode)
        {
            Id = id;
