...
{
    public class LoadTestClientTest: RecordedTestBase<LoadTestClientTestEnvironment>
    {
        public LoadTestClientTest(bool isAsync) : base(isAsync)
        {
        }

        /* Greate the client and instrument it as following. */
        // private LoadTestClient CreateClient()
        // {
        ...
        //         return true;
        //     };
        //     var options = new LoadTestClientOptions { Transport = new HttpClientTransport(httpHandler) };
        //     var client = InstrumentClient(
        //         new LoadTestClient(TestEnvironment.Endpoint, TestEnvironment.<other-client-parameters>, TestEnvironment.Credential, InstrumentClientOptions(options)));
        //     return client;
        // }
