...
namespace Azure.Learn.AppConfig
{
    internal partial class ServiceRestClient
    {
        ...
        internal HttpMessage CreatePutKeyValueRequest(string key, string ifMatch, string ifNoneMatch, ConfigurationSetting setting)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            if (setting != null)
            {
                ...
                content.JsonWriter.WriteObjectValue(setting);
                request.Content = content;
            }
            return message;
        }

        /// <summary> Creates or updates a key-value. </summary>
        ...
        /// <param name="setting"> The key-value to create. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<Response<ConfigurationSetting>> PutKeyValueAsync(string key, string ifMatch = null, string ifNoneMatch = null, ConfigurationSetting setting = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
            ...
            using var message = CreatePutKeyValueRequest(key, ifMatch, ifNoneMatch, setting);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="setting"> The key-value to create. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<ConfigurationSetting> PutKeyValue(string key, string ifMatch = null, string ifNoneMatch = null, ConfigurationSetting setting = null, CancellationToken cancellationToken = default)
        {
            if (key == null)
            {
                throw new ArgumentNullException(nameof(key));
