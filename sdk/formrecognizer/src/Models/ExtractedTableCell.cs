...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    {
        internal ExtractedTableCell(string text, float[] boundingBox, int rowIndex, int columnIndex, int rowSpan, int columnSpan, bool isHeader, bool isFooter, float confidence, ExtractedTable table, IReadOnlyList<RawExtractedLine> rawTableCellExtraction)
        {
            Text = text;
            ...
            Table = table;
            RawTableCellExtraction = rawTableCellExtraction;
        }
