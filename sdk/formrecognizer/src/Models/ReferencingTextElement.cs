...
namespace Azure.AI.FormRecognizer.Models
{
    ...
    internal abstract class ReferencingTextElement : TextElement
    {
        ...
        /// <see cref="TextElement" /> relative to a given <see cref="RawExtractedPageInfo" />.
        ///
        ...
        internal void ResolveTextReferences(RawExtractedPageInfo[] readResults)
        {
        ...
        internal static TextElement ResolveTextReference(RawExtractedPageInfo[] results, string reference)
        {
            TextElement textElement = null;
            RawExtractedPageInfo readResult = null;
