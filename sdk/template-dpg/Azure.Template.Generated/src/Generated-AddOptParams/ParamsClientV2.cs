...
namespace Azure.Template.Generated
{
    ...
    public partial class ParamsClientV2
    {
        ...
        public ParamsClientV2(TokenCredential credential, Uri endpoint = null, LLCClientOptions options = null)
        {
            if (credential == null)
            {
...
#pragma warning disable AZC0002
        public virtual async Task<Response> NoParamsAsync(RequestContext context)
#pragma warning restore AZC0002
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
#pragma warning disable AZC0002
        public virtual Response NoParams(RequestContext context)
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ParamsClient.NoParams");
            scope.Start();
        ...
        /// <param name="context"> The request context. </param>
#pragma warning disable AZC0002
        public virtual async Task<Response> NoParamsAsync(string newParameter = null, RequestContext context = null)
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ParamsClient.NoParams");
            scope.Start();
            try
            {
                using HttpMessage message = CreateNoParamsRequest(newParameter);
                return await _pipeline.ProcessMessageAsync(message, _clientDiagnostics, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <param name="context"> The request context. </param>
#pragma warning disable AZC0002
        public virtual Response NoParams(string newParameter = null, RequestContext context = null)
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ParamsClient.NoParams");
            scope.Start();
...
#pragma warning restore AZC0002
        {
            ...
            try
            {
                using HttpMessage message = CreatePutRequiredOptionalRequest(requiredParam, optionalParam, newParameter);
                return await _pipeline.ProcessMessageAsync(message, _clientDiagnostics, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
...
#pragma warning restore AZC0002
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
#pragma warning disable AZC0002
        public virtual async Task<Response> PostParametersAsync(RequestContent content, RequestContext context)
#pragma warning restore AZC0002
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
#pragma warning disable AZC0002
        public virtual Response PostParameters(RequestContent content, RequestContext context)
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ParamsClient.PostParameters");
            scope.Start();
        ...
        /// </remarks>
#pragma warning disable AZC0002
        public virtual async Task<Response> PostParametersAsync(RequestContent content, string newParameter = null, RequestContext context = null)
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ParamsClient.PostParameters");
            scope.Start();
            try
            {
                using HttpMessage message = CreatePostParametersRequest(content, newParameter);
                return await _pipeline.ProcessMessageAsync(message, _clientDiagnostics, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// </remarks>
#pragma warning disable AZC0002
        public virtual Response PostParameters(RequestContent content, string newParameter = null, RequestContext context = null)
#pragma warning restore AZC0002
        {
            using var scope = _clientDiagnostics.CreateScope("ParamsClient.PostParameters");
            scope.Start();
...
#pragma warning restore AZC0002
        {
            ...
            try
            {
                using HttpMessage message = CreateGetOptionalRequest(optionalParam, newParameter);
                return await _pipeline.ProcessMessageAsync(message, _clientDiagnostics, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
...
#pragma warning restore AZC0002
        ...
        internal HttpMessage CreateNoParamsRequest(string newParameter)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Head;
        ...
        internal HttpMessage CreatePutRequiredOptionalRequest(string requiredParam, string optionalParam, string newParameter)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        internal HttpMessage CreatePostParametersRequest(RequestContent content, string newParameter)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        internal HttpMessage CreateGetOptionalRequest(string optionalParam, string newParameter)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
